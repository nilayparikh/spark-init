...
| `INTERFACE_QWEN_3_6_27B_BASE_URL` | `http://host.docker.internal:8000/v1` | Base URL for the 27B backend (as seen from LiteLLM). |
| `INTERFACE_QWEN_3_6_27B_API_KEY` | `sk-dummy` | API key for the 27B backend (llama.cpp doesn't require auth, but LiteLLM expects one). |
| `INTERFACE_QWEN_3_6_27B_MODEL` | `openai/qwen3.6_27b` | Model ID exposed by LiteLLM for the 27B model. |
...
| `INTERFACE_QWEN_3_6_35B_A3B_BASE_URL` | `http://host.docker.internal:8001/v1` | Base URL for the 35B A3B backend (as seen from LiteLLM). |
| `INTERFACE_QWEN_3_6_35B_A3B_API_KEY` | `sk-dummy` | API key for the 35B A3B backend. |
| `INTERFACE_QWEN_3_6_35B_A3B_MODEL` | `openai/qwen3.6_35b_a3b` | Model ID exposed by LiteLLM for the 35B A3B model. |
...
- `INTERFACE_QWEN_3_6_27B_API_KEY` and `INTERFACE_QWEN_3_6_35B_A3B_API_KEY` can remain `sk-dummy` because llama.cpp doesn't enforce authentication — the proxy handles auth before requests reach the backend.
