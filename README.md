...
[![CI](https://github.com/nilayparikh/init-stack/actions/workflows/lint.yml/badge.svg)](https://github.com/nilayparikh/init-stack/actions/workflows/lint.yml)
...
cp .env.example .env
# edit .env: set LLAMA_QWEN_3_6_27B_GGUF_MODEL_PATH and LITELLM_MASTER_KEY
docker compose up -d
```
