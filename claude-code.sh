...
DOCKER_OPTS=(
  ...
  # System fallbacks
  -e ANTHROPIC_CUSTOM_MODEL_OPTION=".INIT/Pro"
  -e ANTHROPIC_CUSTOM_MODEL_OPTION_NAME=".INIT/Pro"
  -e ANTHROPIC_CUSTOM_MODEL_OPTION_DESCRIPTION="DGX/Qwen3.6-27B via LiteLLM"
  ...
  -e ANTHROPIC_DEFAULT_HAIKU_MODEL_DESCRIPTION="DGX/Qwen3.6-35B-A3B via LiteLLM"
)
